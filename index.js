...
const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbxuObJmrkMmbfEU7xE1JIEwufBimv6TfcTHnHckqUor3YoPpAaZuzl82rNq-HUGC-JZiw/exec';
const GRUPO_ID = '120363403512588677@g.us';

const wss = new WebSocket.Server({ port: 8080 });
let sock;

// Configuração do gráfico (substituída pela do primeiro bot)
...
// Função gerarGrafico do primeiro bot (substituída)
...
async function iniciarBot() {
  ...
  sock.ev.on('messages.upsert', async ({ messages }) => {
    ...
    try {
      ...
      // Comando de gráfico (substituído pelo do primeiro bot)
